...
public enum Cake
{
    ...
    /**
     * Method findMatchingCake
     *
     * @param cake:  Given a string cake type like "chocolate", will return the corresponding enum
     *                      like Cake.CHOCOLATE
     * @return The Cake enum or UNKNOWN if we couldn't match the input String
     */
